...
public class ShopSystem {
	...
	public void showCurrentAccountTrolley() throws AccountIsNotCustomerException,AccountIsEmptyException {
		if(currentAccountIsCustomer()) {
			...
			int count = 1;
			System.out.println("Account:w " + currentAccount.getName() + " ," + shoppingTrolley.size() + " item(s) in your shopping trolley.");
	...
	public Company searchCompanyById(String company) throws NoSuchCompanyException {
